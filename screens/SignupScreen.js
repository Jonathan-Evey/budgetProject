  ...
  return (
    <KeyboardAvoidingView style={styles.container}> 
        <View style={styles.subContainer}>
          ...
          <Text style={styles.subTitle}>Please fill in the details below to start your buget and saving journey with Allotment.</Text>
        </View>
        <View style={styles.subContainer}>
          <View>
            <TextInput 
            ...
            />
            {nameError ? <Text style={styles.error}>Name must be at least three characters</Text> : null}
          </View>
          <View>
            <TextInput 
              style={styles.textInput}
          ...
          <View>
            <TextInput 
              ...
              secureTextEntry
            />
            {passwordError ? <Text style={styles.error}>Password must be at least eight characters</Text> : null}
          </View>
          <View>
            <TextInput 
              style={styles.textInput}
              ...
              secureTextEntry
            />
            {confirmPasswordError ? <Text style={styles.error}>Passwords must match</Text> : null}
          </View>
